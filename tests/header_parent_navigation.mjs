...
for (const source of ["/dashboard-actions/home", "/dashboard-rooms-v11/rooms", "/dashboard-infrastructure/overview"]) {
 ...
 assert.equal(vm.runInContext('captureNikasShellReturnRoute({panelId:"lider_voltage_control",parentRoute:"/home/overview",safeReturnRoute:"/home/overview"})', context), "/home/overview");
}
