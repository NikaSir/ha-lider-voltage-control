...
def main():
    ...
    require(pm["template_version"]=="1.9","panel template must be 1.9");require(pm["ui_version"]=="0.9.2","panel UI version mismatch")
    require(pm["overview"]["equipment_model"]=="LIDER PS-7500W-30","equipment model mismatch")
    require(pm["phase_views"]["layout"]=="three_phases_in_one_row","phase view layout mismatch")
    ...
    print("NikaS v1.9 clean LIDER 0.9.2 contract: PASS")
